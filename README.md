...
- **Zarządzanie użytkownikami** - Przeglądanie, dodawanie i usuwanie kont użytkowników
...
Z uwagi na wygodę w repozytorium umieśliliśmy plik z bazą danych, aby po uruchomieniu aplikacji przykładowe dane były już załadowane.
...
Jeśli pojawią się jakieś problemy, można spróbować też takiej sekwencji komend:
...
Panel administratora jest dostępny dla użytkowników z uprawnieniami administratora. Konto administratora tworzone jest automatycznie podczas uruchamiania aplikacji.
...
| `POST`   | `/api/auth/register` | Dodanie nowego użytkownika     |
